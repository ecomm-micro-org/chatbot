...
class ChatbotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateDescription = channel.unary_unary(
            "/chatbot.ChatbotService/GenerateDescription",
            request_serializer=chatbot__pb2.GenerateDescriptionRequest.SerializeToString,
            response_deserializer=chatbot__pb2.GenerateDescriptionResponse.FromString,
            _registered_method=True,
        )
...
def add_ChatbotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GenerateDescription": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=chatbot__pb2.GenerateDescriptionRequest.FromString,
            response_serializer=chatbot__pb2.GenerateDescriptionResponse.SerializeToString,
        ),
    }
...
class ChatbotService(object):
    ...
    def GenerateDescription(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/chatbot.ChatbotService/GenerateDescription",
            chatbot__pb2.GenerateDescriptionRequest.SerializeToString,
            chatbot__pb2.GenerateDescriptionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
